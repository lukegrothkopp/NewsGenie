SYSTEM_CLASSIFIER = '''You are NovaFeed, a routing assistant.
...
SYSTEM_SUMMARIZER = '''You are NovaFeed, a concise summarizer.
...
SYSTEM_ANSWER = '''You are NovaFeed, a helpful assistant.
